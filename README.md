...
Landing page moderna y persuasiva diseñada para vender el ebook "Respuestas Católicas a Preguntas Inesperadas" por $6.99 USD, con una oferta complementaria del "Mini Devocionario Apologético" por $3.99 USD.
...
```javascript
const PAYMENT_LINKS = {
    mainProduct: 'TU_LINK_DE_HOTMART_AQUI', // Ebook principal $6.99
